...
public class SalonUslugaDto implements Serializable {
    ...
    private final Integer trajanjeUsluge;
    private final LocalDate datumKraja;
    private final String status;
    private final Double cijena;
    private final String opis;

    public SalonUslugaDto(Long id, Long salonId, Long uslugaId, LocalDate datumPocetka, Integer trajanjeUsluge, LocalDate datumKraja, String status, Double cijena, String opis) {
        this.id = id;
